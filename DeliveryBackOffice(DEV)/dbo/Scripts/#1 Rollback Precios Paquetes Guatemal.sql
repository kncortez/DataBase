...
UPDATE [dbo].[CatSubscription]
SET SubscriptionDescription ='300 guías a Q26.00 c/u.',
    SubscriptionCost=7800.00,
	DateUpdated=GETDATE(),
	TokenUpdated='SYS-EVASQUEZ'
...
UPDATE  [dbo].[CatSubscriptionDescription]
SET [Description]='Nuestro paquete te ofrece 300 guías de envío prepagadas con Tarifa única a todo el país, lo que significa que puedes enviar tus productos a cualquier destino sin preocuparte por tarifas variables. Pero eso no es todo, ¡nuestra tarifa es la más barata del mercado! Ahorra y optimiza con nuestras guías prepagadas que ofrecen una ayuda invaluable para tu negocio. ¿Tienes una gran cantidad de envíos de manera continua? Estas guías son ideales para ti. Simplifica tus procesos de envío, obtén la tranquilidad de una tarifa fija y la comodidad de un proceso simplificado. ¡Haz que tus envíos sean más rentables y eficientes hoy mismo!',
    DateUpdated=GETDATE(),
	TokenUpdated='SYS-EVASQUEZ'
...
And SubscriptionAttributeDescription='15 guías a Q32.40 c/u.'
...
And SubscriptionAttributeDescription='25 guías a Q30.60 c/u.'


UPDATE dbo.CatSubscriptionAtribute
  SET SubscriptionAttributeDescription='50 guias a Q32.00 c/u.',
      DateUpdated=GETDATE(),
	  TokenUpdated='SYS-EVASQUEZ'
where CatSubscriptionId=@IdCatSubscriptionBASICO 
And SubscriptionAttributeDescription='50 guias a Q25.00 c/u.'
...
And SubscriptionAttributeDescription='100 guías a Q27.00 c/u.'
...
And SubscriptionAttributeDescription='300 guías a Q23.40 c/u.'
...
And SubscriptionAttributeDescription='400 guías a Q21.60 c/u.'
...
And SubscriptionAttributeDescription='500 guías a Q19.80 c/u.'



/* Inhabilitar imagene promocional 10% bono 14 */

  UPDATE [DeliveryBackOffice].[dbo].[MarketplaceCarouselImage]
  SET [RowStatus] = 0
  WHERE [RowStatus] = 1 AND  IdCountry ='GT'
  AND [XXLImageURL] ='https://forzadelivery.com/images/Tienda/slider04-1920-300.jpg'


/*Remover distinción y categoria de novedad*/
