...
BEGIN TRY
	...
	DECLARE @BaseLocCODPrice DECIMAL(14,2) = 21.00;
	DECLARE @BaseMetCODPrice DECIMAL(14,2) = 25.00;
	DECLARE @BaseForCODPrice DECIMAL(14,2) = 32.00;
	DECLARE @BaseEspCODPrice DECIMAL(14,2) = 39.00;
	/* BLOQUE PENDIENTE DE CONFIRMAR */
