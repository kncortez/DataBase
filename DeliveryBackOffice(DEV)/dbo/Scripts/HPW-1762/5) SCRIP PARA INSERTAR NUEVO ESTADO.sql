...
BEGIN TRY
    BEGIN TRANSACTION;
		...
		VALUES ('COD Anticipado',1,2,'La guia de COD Anticipado fue procesada exitosamente','La guia de COD Anticipado fue procesada exitosamente',1,'SYS-ORODRIGUEZ',GETDATE(),1)
