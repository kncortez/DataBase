...
BEGIN TRY
    BEGIN TRANSACTION;
		...
		('GuideAmountCODAnticipatedParam','Valor maximo por guia para validacion general de COD Anticipado',2400,1,GETDATE(),'HN',NULL),
		...
		('ValueCODComisison1Param','Valor de comision COD Anticipado rango 1 - 300',1,1,GETDATE(),'GT',NULL),
		('MinRangeCODComisison1Param','Minimo de rango para comision COD Anticipado rango 1 - 300',1,1,GETDATE(),'HN',NULL),
		('MaxRangeCODComisison1Param','Maximo de rango para comision COD Anticipado rango 1 - 300',900,1,GETDATE(),'HN',NULL),
		('ValueCODComisison1Param','Valor de comision COD Anticipado rango 1 - 300',3,1,GETDATE(),'HN',NULL),
		...
		('MinRangeCODComisison2Param','Minimo de rango para comision COD Anticipado rango 301 - 600',901,1,GETDATE(),'HN',NULL),
		('MaxRangeCODComisison2Param','Maximo de rango para comision COD Anticipado rango 301 - 600',1800,1,GETDATE(),'HN',NULL),
		('ValueCODComisison2Param','Valor de comision COD Anticipado rango 301 - 600',3,1,GETDATE(),'HN',NULL),
		...
		('MinRangeCODComisison3Param','Minimo de rango para comision COD Anticipado rango 601 - 800',1801,1,GETDATE(),'HN',NULL),
		('MaxRangeCODComisison3Param','Maximo de rango para comision COD Anticipado rango 601 - 800',2400,1,GETDATE(),'HN',NULL),
		('ValueCODComisison3Param','Valor de comision COD Anticipado rango 601 - 800',3,1,GETDATE(),'HN',NULL)
	COMMIT TRANSACTION 
END TRY
BEGIN CATCH
