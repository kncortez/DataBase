...
INSERT INTO [dbo].[ContentTitle]([TypeContentId],[ContentTitle],[ContentDescription],[RowStatus],[DateCreated],[TokenCreated],[CountryId])
     VALUES (1,'¿Cómo realizar un envío?','Envío Fácil, Entrega Rápida',1,GETDATE(),'SYS-TGARCIA','HN')
INSERT INTO [dbo].[ContentTitle]([TypeContentId],[ContentTitle],[ContentDescription],[RowStatus],[DateCreated],[TokenCreated],[CountryId])
     VALUES (1,'¿Como asegurar los paquetes?','Seguro en tránsito',1,GETDATE(),'SYS-TGARCIA','HN')
INSERT INTO [dbo].[ContentTitle]([TypeContentId],[ContentTitle],[ContentDescription],[RowStatus],[DateCreated],[TokenCreated],[CountryId])
     VALUES (1,'¿Qué tipo de embalaje utilizar?','¡Protege tu paquete!',1,GETDATE(),'SYS-TGARCIA','HN')
INSERT INTO [dbo].[ContentTitle]([TypeContentId],[ContentTitle],[ContentDescription],[RowStatus],[DateCreated],[TokenCreated],[CountryId])
     VALUES (1,'¿Qué es una guía?','Generación de guía',1,GETDATE(),'SYS-TGARCIA','HN')
INSERT INTO [dbo].[ContentTitle]([TypeContentId],[ContentTitle],[ContentDescription],[RowStatus],[DateCreated],[TokenCreated],[CountryId])
     VALUES (1,'¿Qué tipo de mercadería envíar?','Mercadería correcta',1,GETDATE(),'SYS-TGARCIA','HN')
INSERT INTO [dbo].[ContentTitle]([TypeContentId],[ContentTitle],[ContentDescription],[RowStatus],[DateCreated],[TokenCreated],[CountryId])
     VALUES (1,'¿Cuáles son las formas de pago?','Formas de Pago',1,GETDATE(),'SYS-TGARCIA','HN')
INSERT INTO [dbo].[ContentTitle]([TypeContentId],[ContentTitle],[ContentDescription],[RowStatus],[DateCreated],[TokenCreated],[CountryId])
     VALUES (1,'¿Cómo solicitar la recolección?','Creación de recolección',1,GETDATE(),'SYS-TGARCIA','HN')
INSERT INTO [dbo].[ContentTitle]([TypeContentId],[ContentTitle],[ContentDescription],[RowStatus],[DateCreated],[TokenCreated],[CountryId])
     VALUES (3,'NUESTROS SERVICIOS','!Entregas en tiempo, al menor costo!',1,GETDATE(),'SYS-TGARCIA','HN')
...
SELECT 
	...
	'SYS-TGARCIA' AS [TokenCreated],
	NULL AS [IsPageURLExternal],
	NULL AS [IsVideoURLExternal]
FROM [dbo].[ContentTitle] 
WHERE ContentTitle = '¿Cómo realizar un envío?' AND CountryId = 'HN'
UNION
-- 13:9
SELECT 
	IdContentTitle AS [ContentTitleId],
	...
	NULL AS [IsVideoURLExternal]
FROM [dbo].[ContentTitle] 
WHERE ContentTitle = '¿Como asegurar los paquetes?' AND CountryId = 'HN'
UNION
-- 15:11
SELECT 
	IdContentTitle AS [ContentTitleId],
	...
	NULL AS [IsVideoURLExternal]
FROM [dbo].[ContentTitle]
WHERE ContentTitle = '¿Qué tipo de embalaje utilizar?' AND CountryId = 'HN'
UNION
-- 16:12
SELECT 
	IdContentTitle AS [ContentTitleId],
	...
	NULL AS [IsVideoURLExternal]
FROM [dbo].[ContentTitle]
WHERE ContentTitle = '¿Qué es una guía?' AND CountryId = 'HN'
UNION
-- 17:13
SELECT 
	IdContentTitle AS [ContentTitleId],
	...
	NULL AS [IsVideoURLExternal]
FROM [dbo].[ContentTitle]
WHERE ContentTitle = '¿Qué tipo de mercadería envíar?' AND CountryId = 'HN' 
UNION
-- 18:14
SELECT 
	IdContentTitle AS [ContentTitleId],
	...
	NULL AS [IsVideoURLExternal]
FROM [dbo].[ContentTitle]
WHERE ContentTitle = '¿Cuáles son las formas de pago?' AND CountryId = 'HN' 
UNION
-- 19:15
SELECT 
	IdContentTitle AS [ContentTitleId],
	...
	NULL AS [IsVideoURLExternal]
FROM [dbo].[ContentTitle]
WHERE ContentTitle = 'NUESTROS SERVICIOS' AND CountryId = 'HN'
UNION
-- 20:15
SELECT 
	IdContentTitle AS [ContentTitleId],
...
SELECT 
	...
	NULL AS [IsVideoURLExternal]
FROM [dbo].[ContentTitle]
WHERE ContentTitle = '¿Cómo solicitar la recolección?' AND CountryId = 'HN'
UNION
-- 24:15
SELECT 
	IdContentTitle AS [ContentTitleId],
