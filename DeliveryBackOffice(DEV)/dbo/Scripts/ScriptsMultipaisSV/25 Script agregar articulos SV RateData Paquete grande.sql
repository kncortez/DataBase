...
--WHERE  ArtName = 'Paquete grande' AND IdCountry IS NULL) --EJEMPLO DEVELOP
...
BEGIN TRY
	...
	WHERE ArtName = 'Paquete grande' AND  IdCountry = 'SV'
	...
	WHERE  AbcIdArticle = @IdArticle AND code = 'EXPSV078'
	...
	WHERE  AbcIdArticle = (SELECT ArtId FROM DeliveryBackOffice.dbo.CatArticle
	WHERE  ArtName = 'Paquete grande' AND (IdCountry IS NULL OR IdCountry = 'GT'))
