...
--WHERE  ArtName = 'Paquete extra grande' AND IdCountry IS NULL) --EJEMPLO DEVELOP
...
BEGIN TRY
	...
	WHERE ArtName = 'Paquete extra grande' AND  IdCountry = 'SV'
	...
	WHERE  AbcIdArticle = @IdArticle AND code = 'EXPSV079'
	...
	WHERE  AbcIdArticle = (SELECT ArtId FROM DeliveryBackOffice.dbo.CatArticle
	WHERE  ArtName = 'Paquete extra grande' AND (IdCountry IS NULL OR IdCountry = 'GT'))

	--SCRIPT AGREGAR DATA PARA ARTICULOS DE HN EN RateData Paquete extra grande
