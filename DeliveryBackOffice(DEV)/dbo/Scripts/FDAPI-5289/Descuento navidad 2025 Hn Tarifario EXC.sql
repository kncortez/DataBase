...
BEGIN TRY
	...
	DECLARE 
		@IdRate			INT = (SELECT RheId from RateHeader WITH(NOLOCK) where RheName ='Tarifario destinos express center' AND CountryId = 'HN'),
	...
	--Servicio Economico,  descuento sobre la tarifa asignada cuando se trate de un env�o originado en una agencia EXC con destino a otra agencia EXC
	UPDATE RateData 
	SET 
