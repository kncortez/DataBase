...
-- Reporte de Membres�as y Suscripciones v4 (septiembre 2023)
...
,IIF(A1.DateCreated < '2023-08-25 00:00:00', --si es menor a la �ltima fecha de publicaci�n
...
UNION
SELECT 
A3.IdSubscription Id,'S' + CAST(A3.IdSubscription AS NVARCHAR) [IdClubForza],A4.SubscriptionName [NombrePaquete],'Suscripciín'[Tipo]
