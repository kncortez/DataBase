...
BEGIN
	...
	VALUES
	(   'NACIONAL GT'			-- CrsName - varchar(100)
	  , 'NAG'					-- CrsShortName - varchar(3)
	  , 'Nacional Guatemala'	-- CrsDescription - varchar(200)
	  , 1						-- CrsRowStatus - bit
	  , 'SYS-BPEDROZA'			-- CrsTokenCreated - varchar(50)
	  , GETDATE()				-- CrsDateCreated - datetime
	  , NULL					-- CrsTokenUpdated - varchar(50)
	  , NULL					-- CrsDateUpdated - datetime
	)
END
-- NACIONAL
UPDATE rt
...
BEGIN 
	...
	VALUES
	(   'METRO GT'        -- CrsName - varchar(100)
	  , 'MEG'        -- CrsShortName - varchar(3)
	  , 'Metro Guatemala'      -- CrsDescription - varchar(200)
	  , 1      -- CrsRowStatus - bit
	  , 'sys-caquino'        -- CrsTokenCreated - varchar(50)
	  , GETDATE() -- CrsDateCreated - datetime
	  , NULL      -- CrsTokenUpdated - varchar(50)
	  , NULL      -- CrsDateUpdated - datetime
		);
...
BEGIN
	...
	VALUES
	(   'REGIONAL GT'        -- CrsName - varchar(100)
	  , 'REG'        -- CrsShortName - varchar(3)
	  , 'Regional Guatemala'      -- CrsDescription - varchar(200)
	  , 1      -- CrsRowStatus - bit
	  , 'sys-caquino'        -- CrsTokenCreated - varchar(50)
	  , GETDATE() -- CrsDateCreated - datetime
	  , NULL      -- CrsTokenUpdated - varchar(50)
...
BEGIN
	...
	VALUES
	(   'FOREANEO PETEN GT'        -- CrsName - varchar(100)
	  , 'FPG'        -- CrsShortName - varchar(3)
	  , 'Foraneo Peten'      -- CrsDescription - varchar(200)
	  , 1      -- CrsRowStatus - bit
	  , 'sys-caquino'        -- CrsTokenCreated - varchar(50)
	  , GETDATE() -- CrsDateCreated - datetime
	  , NULL      -- CrsTokenUpdated - varchar(50)
