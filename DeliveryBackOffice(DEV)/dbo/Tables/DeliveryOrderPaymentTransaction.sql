...
GO
CREATE NONCLUSTERED INDEX [IX_DeliveryOrderPaymentTransaction_GuideTypeService]
    ON [dbo].[DeliveryOrderPaymentTransaction]([GuideSerie] ASC, [GuideNumber] ASC, [TypeServiceId] ASC);
