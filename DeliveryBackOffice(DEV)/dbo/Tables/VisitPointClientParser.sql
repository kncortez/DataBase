CREATE TABLE [dbo].[VisitPointClientParser] (
    ...
    CONSTRAINT [FK_VisitPointClient_Customer] FOREIGN KEY ([CustomerID]) REFERENCES [dbo].[CustomerParser] ([IdCustomer]),
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Desktop Visitpoint', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'VisitPointClientParser', @level2type = N'COLUMN', @level2name = N'VisitPointId';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Correo del punto de visita', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'VisitPointClientParser', @level2type = N'COLUMN', @level2name = N'Email';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Se refiere al número de sucursal de la agencia, tienda u oficina identificada por cliente', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'VisitPointClientParser', @level2type = N'COLUMN', @level2name = N'BranchCode';
