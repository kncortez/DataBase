...
/****** Object:  Table [dbo].[MarketplaceCartDetail]    Script Date: 11/27/2023 11:45:21 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[MarketplaceCartDetail]  WITH CHECK ADD  CONSTRAINT [FK_MarketplaceCartDetail_Product] FOREIGN KEY([ProductId])
REFERENCES [dbo].[Product] ([IdProduct])
GO

ALTER TABLE [dbo].[MarketplaceCartDetail] CHECK CONSTRAINT [FK_MarketplaceCartDetail_Product]
GO
