...
/****** Object:  Table [dbo].[MarketplaceCartDetail]    Script Date: 1/12/2023 10:42:53 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[MarketplaceCartDetail]  WITH CHECK ADD  CONSTRAINT [FK_MarketplaceCartDetail_CatProduct] FOREIGN KEY([ProductId])
REFERENCES [dbo].[CatProduct] ([IdCatProduct])
GO

ALTER TABLE [dbo].[MarketplaceCartDetail] CHECK CONSTRAINT [FK_MarketplaceCartDetail_CatProduct]
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Producto' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'MarketplaceCartDetail', @level2type=N'COLUMN',@level2name=N'ProductId'
GO
