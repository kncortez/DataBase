CREATE TABLE [dbo].[ConfigParams] (
    ...
    CONSTRAINT [FK_ConfigParams_CatCountry] FOREIGN KEY ([IdCountry]) REFERENCES [dbo].[CatCountry] ([IdCountry]),
    CONSTRAINT [FK_ConfigParams_CatCurrencyCOD] FOREIGN KEY ([IdCurrencyCOD]) REFERENCES [dbo].[CatCurrencyCOD] ([IdCatCurrencyCOD])
);
