...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Llave foranea a la tabla de partes responsables Cliente,forza', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'CatTypeIncidence', @level2type = N'COLUMN', @level2name = N'CatPartyResponsibleId';
