...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'CatRoute',
    @level2type = N'COLUMN',
    @level2name = N'IdRoute'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Codigo de la ruta',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'CatRoute',
    @level2type = N'COLUMN',
    @level2name = N'CodeRoute'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Descripción de la ruta',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'CatRoute',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'id del departamento(Referencia a IdTownship de la tabla Township)',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'CatRoute',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'id del tipo de ruta(Refencia a IdTypeRoute de la tabla CatTypeRoute)',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'CatRoute',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Estado(1 Activa, 0 Inactivo)',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'CatRoute',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Catalogo de rutas que puede tomar un corier',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'CatRoute',
