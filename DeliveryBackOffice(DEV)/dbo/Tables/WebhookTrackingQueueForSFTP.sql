...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Direcci�n del hostname para enviar informaci�n' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'WebhookTrackingQueueForSFTP', @level2type=N'COLUMN',@level2name=N'Hostname'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Fecha y hora de env�o del lote' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'WebhookTrackingQueueForSFTP', @level2type=N'COLUMN',@level2name=N'ShippingDate'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Indica si el env�o fue v�lido o no' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'WebhookTrackingQueueForSFTP', @level2type=N'COLUMN',@level2name=N'HasNotified'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Usuario de creaci�n' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'WebhookTrackingQueueForSFTP', @level2type=N'COLUMN',@level2name=N'TokenCreated'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Fecha de creaci�n' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'WebhookTrackingQueueForSFTP', @level2type=N'COLUMN',@level2name=N'DateCreated'
GO
