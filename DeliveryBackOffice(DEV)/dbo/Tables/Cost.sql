...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Tipo de monedo para pago de envio', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Cost', @level2type = N'COLUMN', @level2name = N'ShippingCurrency';

GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Tipo de monedo de pago COD', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Cost', @level2type = N'COLUMN', @level2name = N'CodCurrency';

GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Tasa de cambio para pago de envio', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Cost', @level2type = N'COLUMN', @level2name = N'ShippingExchangeRate';

GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Tasa de cambio para pago de COD', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Cost', @level2type = N'COLUMN', @level2name = N'CodExchangeRate';