...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Tabla que almacena información de facturación favoritos, clientes individuales', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BillingProfile';
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Código de actividad económica del cliente', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BillingProfile', @level2type = N'COLUMN', @level2name = N'ActivityCode';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Tipo de factura asociada al perfil', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'BillingProfile', @level2type = N'COLUMN', @level2name = N'Inv_type';
