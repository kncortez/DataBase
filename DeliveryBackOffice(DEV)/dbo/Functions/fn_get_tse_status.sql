...
BEGIN
    ...
    -- Status 1 = Solicitado
    DECLARE @msgSolicitado NVARCHAR(60) = N'Pendiente de Entregar';
    -- Status 2 = Recolectado
    DECLARE @msgRecolectado NVARCHAR(60) = N'Pendiente de Entregar';
    -- Status 11 = Arribó a Instalaciones
    DECLARE @msgArribo NVARCHAR(60) = N'Pendiente de Entregar';
    -- Status 4 = En Ruta
    DECLARE @msgEnRuta NVARCHAR(60) = N'Pendiente de Entregar';
    -- Status 5 = Entregado
    DECLARE @msgEntregado NVARCHAR(60) = N'Entregado en Centro de Votación';
    -- Status 32 = Declarado para devolución
    DECLARE @msgDeclaradoDevolucion NVARCHAR(60) = N'Entregado en Centro de Votación';
    -- Status 2 = Recolectado (devolución)
    DECLARE @msgRecolectado2 NVARCHAR(60) = N'Recolectado en Centro de Votación';
    -- Status 14 = Devuelto
    DECLARE @msgDevuelto NVARCHAR(60) = N'Recolectado en Centro de Votación';
