...
BEGIN
    ...
    CREATE NONCLUSTERED INDEX INDX_GetGeneratedBatchCODDaily_tmp
    ON #GuidesProcessCOD (
                             GuideSerie,
                             GuideNumber
                         );
    ...
    BEGIN TRY
        ...
        DECLARE @AccountType NVARCHAR(50)
            = IIF(@IdCountrySender = 'GT', N'MONETARIA', IIF(@IdCountrySender = 'SV', N'CORRIENTE', N'CHEQUES'));
        DECLARE @ConceptCustomer NVARCHAR(50) = N'PAGO';
        DECLARE @CreditAccount NVARCHAR(50)
            = IIF(@IdCountrySender = 'GT', N'903666261', IIF(@IdCountrySender = 'SV', N'903666263', N'730512881'));
        ...
        BEGIN
            ...
            CREATE NONCLUSTERED INDEX tempSerieNumber
            ON #listGuidesDaily (
                                    Guide_Serie,
                                    Guide_Number
                                );
            ...
            ON #TableAmountCODDailyTemp ([CODtoPay]);
