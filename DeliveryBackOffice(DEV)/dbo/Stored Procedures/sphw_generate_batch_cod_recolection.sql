...
BEGIN
    ...
    BEGIN
        ...
        -- error.  
        SAVE TRANSACTION generate_batch_cod_rec_Save;
    END;
    ELSE
    BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            -- CONSTRUCCION DE REGISTROS PARA EL PAGO A FORZA DE LOS PAGOS EN RECOLECCIÓN
            SELECT tact.Guide_Serie GuideSerie,
                   ...
                   COALESCE(do.PriceShippment, tact.Price, 0) Amount,
                   0 [Commision],
                   (
            ...
            BEGIN
                ...
                BEGIN
                    -- SE CREA EL DETALLE DEL LOTE PARA EL PAGO A FORZA DE LOS PAGOS EN RECOLECCIÓN
    ...
    BEGIN CATCH
        ...
        BEGIN
            ...
            BEGIN
                ...
                ROLLBACK TRANSACTION generate_batch_cod_rec_Save;
    ...
    BEGIN
        ...
        BEGIN
            SELECT @BankBAC PayingBank,
                   ...
                   'TRUE' AS blnResult,
                   'SE GENERO LOTE DE PAGOS EN RECOLECCIÓN' Comment;
        END;
        ...
        BEGIN
            ...
            SELECT @BankBAC PayingBank,
                   ...
                   @NewIdBatchCODForza AS BATCHNUMBER,
                   'TRUE' AS blnResult,
                   'LOTE DE PAGOS EN RECOLECCIÓN' Comment;
        END;
    ...
    END;
END;
PROCEDURE [dbo].[sphw_generate_batch_cod_recolection]
    @IdBankParam INT,
    @BatchTimeRange VARCHAR(300) = '',
    @CoDProcessID INT,
	@IdCountrySender NVARCHAR(50) = N'GT'
