CREATE PROCEDURE [dbo].[RDL_New_ReportFacturation_Job]
    @StartDate DATETIME,
    @EndDate DATETIME,
...
BEGIN
	...
	IF OBJECT_ID('DM_Delivery.dbo.ReportFacturationFilter0', 'U') IS NOT NULL 
			DELETE DM_Delivery.dbo.ReportFacturationFilter0;
	...
	BEGIN
		...
		BEGIN
			...
			INSERT INTO DM_Delivery.dbo.ReportFacturationFilter0
			(
				Ultimo_estado,
				Origen_de_guia,
				Cliente,
			...
			SELECT 
				...
				KindOfVPName,
				CommercialSegmentName 
			FROM DM_Delivery.dbo.ReportFacturationFilter0 RP
	...
	END
		...
		--IF OBJECT_ID('DM_Delivery.dbo.ReportFacturationFilter0', 'U') IS NOT NULL 
		--	DROP TABLE DM_Delivery.dbo.ReportFacturationFilter0;
