...
-- =============================================
CREATE PROCEDURE [dbo].[supportCreateNewExc_NOUSAR]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[supportCreateNewExc_NOUSAR] TO [ebarrios]
    AS [dbo];


GO
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[supportCreateNewExc_NOUSAR] TO [cvaldes]
    AS [dbo];
