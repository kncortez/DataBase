--EXEC spg_deliveryorders_by_number_delivery_returns @_NUMBER='9552384,9552385,9552184'
-- =============================================
-- Author:		<Tito Garcia>
...
BEGIN
    ...
    SELECT
		...
		,dod.StatusOrderId
		,dp.PathSignature
		--,'https://develop.apicore.forzadelivery.io:40466/CourierApp/GetImage?id=SU1BR0VfU0lHTkFUVVJFX0RFTElWRVJZMjAyNC0wNy0yNS0xNDI5NDgyOTQ4LmpwZw==' [PathSignature]
		--,CAST('https://onlinejpgtools.com/images/examples-onlinejpgtools/mountains-near-water.jpg' AS NVARCHAR(MAX)) [PathSignature]
