...
-- =============================================
-- Author:		<Edelman V�squez>
-- Create date: <2022-09-09>
-- Description:	<SP Finalizaci�n de procesos abiertos en preparaci�n de entrega de hermes mobile>
-- =============================================
...
BEGIN
	...
	DECLARE @IsReturn AS BIT = 0--bandera de dvoluci�n
	...
	BEGIN
		...
		-- Generar asignaci�n de ruta para futuro proceso
	...
	BEGIN
		...
		EXEC [dbo].[spws_get_guide_pending_payment] 
			@GUIDECONCAT, -- Gu�as recibidas
			3,            -- Tiempo de pago 3 - En devoluci�n
			1,            -- Si es devoluci�n
			'',           -- Codeapp
	...
	WHERE  RPD.Guide_Serie  = @GuideSerie AND 
		   ...
		   AND RPD.IsOpenProcess = 1
			...
			--- Actualizar los tipos de pieza del detalle de la preparaci�n de ruta segun lo almacenado
			UPDATE RPDP
