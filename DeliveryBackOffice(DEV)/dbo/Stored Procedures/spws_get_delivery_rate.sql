                        ...
                        BEGIN
                            ...
                            IF @ServiceValueSubscription >= 0
                                ...
                                BEGIN
									...
									SELECT @Discount = --IIF(@DescriptionTypeSubscription = 'Porcentaje', (tr.IrregularPieceRate * (@DiscountValue/100)),@DiscountValue)
									IIF(@DescriptionTypeSubscription = 'Porcentaje', (tr.IrregularPieceRate * (@DiscountValue/100)), (IIF(@DiscountValue IS NULL,tr.IrregularPieceRate,@DiscountValue)))
									, @NewPriceShippment
                                                     = (tr.FragilRate + tr.CollectedRate + tr.InsuranceRate
                                                        + tr.OverWeightRate
                                                       )
