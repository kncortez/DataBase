...
begin
	...
	DECLARE @EndDate DATE = convert(DATE, GETDATE() - 0)
	...
	SELECT [Settlement_ID]
	  ...
	  ,[Dispatched_Guides]
	  ,[Dispatched_Pieces]
	  ,[Delivered_Guides_Checkpoint]
	  ,[Delivered_Pieces_Checkpoint]
	  ,[Returned_Guides_Checkpoint]
	  ,[Returned_Pieces_Checkpoint]
	  ,[Returned_Guides]
	  ,[Returned_Pieces]
	  ,[Transfer_Guides_Checkpoint]
	  ,[Transfer_Pieces_Checkpoint]
	  ,[NonOperatedGuides]
	  ,[NonOperatedGuidesPiece]
	  ...
	  ,[FalseIncidents]
	  ,[OperatedIncidence]
	FROM [historical_delivery].[dbo].[TorreControl] -- datos históricos del 01 de enero al 31 de julio del 2024
