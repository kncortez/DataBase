...
-- =============================================
CREATE PROCEDURE [dbo].[SupportCreatNewDesktopUser_NOUSAR]
    @Code INT
  , @User NVARCHAR(50)
  , @Token NVARCHAR(50)
  , @rol INT
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SupportCreatNewDesktopUser_NOUSAR] TO [ebarrios]
    AS [dbo];


GO
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[SupportCreatNewDesktopUser_NOUSAR] TO [cvaldes]
    AS [dbo];
