...
-- Description:	<Se agrega la validacion del pais, verificando si se logueo sesion con el pais correcto>
-- =============================================
					...
					BEGIN
						...
						BEGIN
							...
							PRINT 'TEST6';
								...
								VALUES
								(@Token, @IdUser, @IdSystem, 0, 0, @IdCountryUser, @IP, 1, @Token, GETDATE(), NULL, NULL);
							END;
