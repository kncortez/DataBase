...
INNER JOIN DeliveryBackOffice.dbo.CorporateManifestDetail cmd ON cmd.GuideSerie = dop.GuideSerie AND cmd.GuideNumber = dop.GuideNumber AND cmd.RowStatus = 1
