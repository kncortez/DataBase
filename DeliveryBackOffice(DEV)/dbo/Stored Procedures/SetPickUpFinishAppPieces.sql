    ...
    BEGIN TRY
        ...
        BEGIN TRY
            ...
            BEGIN
                ...
                DECLARE @TargetPointAsText NVARCHAR(MAX)
                    = CONCAT('POINT (', @PickupLongitude, ' ', @PickupLatitude, ')');
        ...
        IF(@TokenAct = 1AND @hourtoken <= 8) OR 1 = 1
        BEGIN
            ...
            CREATE NONCLUSTERED INDEX tempTemp ON #TempResult (Guide);
