...
-- =============================================
CREATE PROCEDURE [dbo].[GetInfoFAC_BNHL] 
...
--FIN TEMPORAL BIDCAR
	...
	INSERT INTO #Tiempo (Descripcion, FechaHora) VALUES ('Inicio de la sección 1', GETDATE());
	...
	INSERT INTO #Tiempo (Descripcion, FechaHora) VALUES ('Primer query', GETDATE());
		...
		BEGIN
			...
			BEGIN
				...
				END
					...
					INSERT INTO #Tiempo (Descripcion, FechaHora) VALUES ('Query 1', GETDATE());
				...
				INSERT INTO #Tiempo (Descripcion, FechaHora) VALUES ('Query 2', GETDATE());
	...
	INSERT INTO #Tiempo (Descripcion, FechaHora) VALUES ('Fin', GETDATE());
