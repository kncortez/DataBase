CREATE procedure [dbo].[Membresías_y_Suscripciones_v5]  
as   
begin  
-- Reporte de Membresías y Suscripciones v5 (Mayo 2024)  
  
-- MEMBRESÍAS = Club FORZA  
SELECT A1.IdMembership Id, 'M'+ CAST(A1.IdMembership AS NVARCHAR) [IdClubForza],A2.MembershipName [NombrePaquete],'Membresía'[Tipo]  
,
CAST(A1.MembershipCost
	/CASE A2.IdCountry
...
,IHD.inv_SAPDocEntry  
,IHD.inv_SAPError  
,IIF(R2.PaymentImageURL IS NOT NULL, 'Telemercadeo Visalink',  
...
,IHD.inv_SAPDocEntry  
,IHD.inv_SAPError  
,IIF(R1.PaymentImageURL IS NOT NULL, 'Telemercadeo Visalink',  
