...
-- Create date: <Create Date,2025-05-06>
-- Description:	<Manejo de moneda multipais>
-- =============================================
...
BEGIN
	...
	Select  CP.IdCatSubscription   [IdCatProduct],
	...
	UNION ALL 
	Select      CP.IdCatMembership   [IdCatProduct],
