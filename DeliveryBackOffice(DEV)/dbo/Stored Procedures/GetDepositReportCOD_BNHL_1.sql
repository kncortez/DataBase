...
--EXEC dbo.GetDepositReportCOD_BNHL @IdCustomer = 0,  -- int
--                             @IdBank = 33,      -- int
--                             @SenderEmail = 'GABRIELARODAS@CORPORACIONFITNESSGT.COM' -- varchar(max)


CREATE PROCEDURE [dbo].[GetDepositReportCOD_BNHL]
