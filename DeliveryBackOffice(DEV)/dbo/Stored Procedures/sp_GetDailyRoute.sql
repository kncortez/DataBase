...
-- Description:	<Devuelve el listado de Direcciones asiganadas a una cuenta (nueva versión de spws_get_daily_route)>
-- =============================================
CREATE PROCEDURE [sp_GetDailyRoute]
    @Token VARCHAR(200) = '',
    @IdCourier BIGINT,
    @DateRoute DATE
AS
BEGIN
    ...
    BEGIN
		...
		SELECT 403 'IdResult', 
			'Token inválido' 'DescriptionError';
