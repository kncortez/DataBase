...
-- =============================================
ALTER PROCEDURE [dbo].[spws_get_list_settlement_by_header_code]
...
AS
BEGIN
	SELECT sett.Settlement, sett.IdSettlement, ISNULL(sett.IdCountry, @CountryId), sett.IsSpecial FROM [dbo].[Settlement] sett
	INNER JOIN 
