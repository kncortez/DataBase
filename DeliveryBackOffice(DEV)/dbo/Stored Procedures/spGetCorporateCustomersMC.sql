...
-- Description:	<Mostrar información facturación SV>
-- =============================================
...
BEGIN
    ...
    SELECT DISTINCT
        ...
        ISNULL(bp.[NRC], '')  AS NRC,
        ISNULL(bp.[TypeIdentificationDocumentCode], '')  AS TypeIdentificationDocumentCode,
        ISNULL(bp.[IdDocument], '')  AS IdDocument,
        ISNULL(bp.[DistrictId], '')  AS DistrictId,
        ISNULL(bp.[StateId], '')  AS StateId,
        ISNULL(bp.[ActivityCode], '')  AS ActivityCode,
        ISNULL(bp.[Inv_type], '')  AS Inv_type,
