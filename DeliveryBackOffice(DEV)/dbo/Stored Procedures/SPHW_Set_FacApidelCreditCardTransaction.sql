...
-- Description:	<Finalización de carrito marketplace, para actualizar el resultado de Trans TC, registrar y activar los productos adquiridos>
-- =============================================


CREATE PROCEDURE [dbo].[SPHW_Set_FacApidelCreditCardTransaction]
    @Type AS INT = -1,
    @System AS INT,
