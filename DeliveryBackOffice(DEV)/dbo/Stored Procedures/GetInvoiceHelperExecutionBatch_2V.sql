...
-- =============================================
create PROCEDURE [dbo].[GetInvoiceHelperExecutionBatch_2V]
    @Option as INT,
            ...
            CREATE NONCLUSTERED INDEX IX_LIP_SERIE ON #listInvoicePending (inv_pk_id);
             ...
             SELECT ibd.Id_Lote
              ...
              WHERE 
                ...
                AND ProcessedCorrelative >= 10222
                AND ProcessedCorrelative <= 11706
        ...
        *********************************************************************************************************************/
             ...
             SELECT ISNULL(IH.inv_pk_id,0) inv_pk_id
               ...
               FROM #listInvoicePending   as LIP
                    ...
                    INNER JOIN [InvoiceDataFixHN] idf  WITH(NOLOCK)
                    ON IH.inv_pk_id = idf.inv_pk_id
