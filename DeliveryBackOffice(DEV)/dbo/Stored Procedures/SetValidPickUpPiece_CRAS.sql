...
-- =============================================  
CREATE PROCEDURE [dbo].[SetValidPickUpPiece_CRAS]
...
SELECT @InGuides [InGuides], @IdPickup [IdPickup], @Token [Token], @IdCountry [Country]

SELECT * FROM @ListReferences
SELECT * FROM @ListContainer
	SELECT * FROM #Temp
