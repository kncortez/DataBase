...
-- =============================================
CREATE PROCEDURE [dbo].[spws_get_rate_estimate]
	-- Add the parameters for the stored procedure here
		    @CodApp as nvarchar(50) = 'SIFDCAPIECOM230920201910',
			@IdDestiny as bigint  = 518,
			...
			@IdSource as bigint = 1454, --zona 12 Guatemala
...
BEGIN
	...
	BEGIN TRY  
		...
		set @IdRedistributor = (select isnull(vp.IdVPCodeOfReference,0) 
								from #VPClient vp 
		...
		----RECARGOS
				...
				from (
						...
						select secure.IdSurcharge				[IdSurcharge],
						 ...
						 AND secure.SuchargeStatus = 'TRUE'
						 ...
						 AND redzone.SuchargeStatus = 'TRUE'
						 ...
						 AND fragil.SuchargeStatus = 'TRUE'
						 --SOBREPESO
						 UNION
						 ...
						 AND Overweight.SuchargeStatus = 'TRUE'
				 ) Surcharges
