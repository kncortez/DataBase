...
-- =============================================
CREATE PROCEDURE [dbo].[spws_get_delivery_rate_CRAS]
...
BEGIN
	...
	*/
	...
	PRINT 'Tarifas por articulo'
        ...
        IF (@IdRate IN ( @NewMainRates, @NewAlternativeRates, @NewAutoSalesMainRates, @NewRateGeneral
