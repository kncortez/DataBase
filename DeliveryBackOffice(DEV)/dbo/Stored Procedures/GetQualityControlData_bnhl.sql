...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            FROM
            (
                SELECT IIF(IncidenceTbl.StatusOrderId = 4, 1, 0)                                                 Pending
                     , IIF(IncidenceTbl.StatusOrderId != 4 AND IncidenceTbl.DeliveryAttemptId IS NULL, 1, 0)     Delivered
                     ...
                     , IncidenceTbl.Guide_Serie                                                                  [GuideSerie]
                     , IncidenceTbl.Guide_Number                                                                 [GuideNumber]
                     , IncidenceTbl.Sender_FirstName + ' ' + IncidenceTbl.Sender_LastName                                 [SenderName]
                     , COALESCE(IncidenceTbl.Receiver_FirstName, '') + ' ' + COALESCE(IncidenceTbl.Receiver_LastName, '') [ReceiverName]
                     , IncidenceTbl.Sender_Phone                                                                 [SenderPhone]
                     , IncidenceTbl.Receiver_Phone                                                               [ReceiverPhone]
                     , IncidenceTbl.Receiver_Address                                                             [ReceiverAddress]
                     ...
                     , IncidenceTbl.PriceShippment
                     , IncidenceTbl.Collect_OnDelivery                                                           [CollectOnDelivery]
                     , IncidenceTbl.OrderDescription
                     , (CASE
                     ...
                     , HUbs.IdHubLogistic
                     , IIF(IncidenceTbl.StatusOrderId = 4, 1, 0)                                                 Pendiente
       ...
       UNION
        ...
        BEGIN
            ...
            (
                SELECT --TOP 1000
                    IIF(IncidenceTbl.StatusOrderId = 4, 1, 0)                                                 Pending
                  , IIF(IncidenceTbl.StatusOrderId != 4 AND IncidenceTbl.DeliveryAttemptId IS NULL, 1, 0)     Delivered
                  , IIF(cfi.IsConfirmed = 1, 1, 0)                                                   ConfirmationIncidents
                  , IIF(cfi.IsConfirmed = 0, 1, 0)                                                   UnConfirmationIncidents
                  , ds.ID
