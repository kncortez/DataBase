...
CREATE PROCEDURE [dbo].[GetUpdateRegisterCODearly]
(
...
BEGIN
    BEGIN TRY
        ...
        SELECT tt.IdCustomer,
          ...
          FROM #TempDate tt 
               LEFT JOIN DeliveryOrder do WITH(NOLOCK)
                 ON tt.PortfolioId = do.VisitpointClientPortfolioId
        ...
        SELECT CU.IdCustomer
          ...
          FROM #TempDate CU WITH (NOLOCK)
               LEFT JOIN DeliveryBackOffice.dbo.DeliveryOrder do WITH(NOLOCK)
                 ON do.VisitpointClientPortfolioId = CU.PortfolioID
        ...
        SELECT IdCustomer,
               ...
               ISNULL(NumbersGuide,0) AS MinGuidesPerMonth,
               ISNULL(AmountCOD / 30.00,0.00) AS DailyAmount,
               CASE
        ...
        (
           SELECT TD.IdCustomer,
              ...
              FROM #TempDate TD
                  LEFT JOIN #TempMinDate TMD
                      ON TMD.IdCustomer = TD.IdCustomer
                         AND TMD.PortfolioID = TD.PortfolioID
