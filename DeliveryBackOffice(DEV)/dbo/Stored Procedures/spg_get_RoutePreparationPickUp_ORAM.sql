...
-- =============================================
CREATE PROCEDURE [dbo].[spg_get_RoutePreparationPickUp_ORAM]
    @datePickUp AS DATE = '',
    @hubId INT = -1,
...
BEGIN
	...
	CREATE CLUSTERED INDEX IX_TempPrice_Guide ON #TempPrice (GuideSerie, GuideNumber);
	...
	CREATE CLUSTERED INDEX IX_tbl_SchedulePickUp ON #tbl (idSchedulePickUp, IdServiceManagement,Address,SchedulePickupStatus);
