...
-- Description:	<Description,Obtener data de varias guías para impresión en formato ZPL por medio de la referencia (OrderNUmber)>
-- =============================================
...
(
    @Tickets dbo.TicketList READONLY
)
AS
BEGIN
	SET NOCOUNT ON;
