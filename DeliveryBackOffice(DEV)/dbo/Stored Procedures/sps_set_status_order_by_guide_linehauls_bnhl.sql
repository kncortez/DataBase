...
-- =============================================
CREATE PROCEDURE [dbo].[sps_set_status_order_by_guide_linehauls_bnhl]
...
END
        ...
        ELSE
        BEGIN
		    PRINT 'NO HACE UPDATE'

			 select StatusOrderId , @StatusOrderId,
                Courier_Route , @Route from DeliveryBackOffice.dbo.DeliveryOrder            
            WHERE Guide_Serie = @Guide_Serie
                  AND Guide_Number = @GuideNumber;
