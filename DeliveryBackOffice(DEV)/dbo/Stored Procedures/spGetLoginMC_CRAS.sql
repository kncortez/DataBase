...
CREATE PROCEDURE [dbo].[spGetLoginMC_CRAS]
					...
					BEGIN
						...
						BEGIN
							...
							BEGIN
								...
								SELECT '1' [RESUTL], * FROM @ModulesTable

								SELECT '2', * FROM @AccountsTable

								SELECT '3', * FROM @ProfileTable

								SELECT '4', * FROM @ProfileEXPTable;
