...
-- =============================================
CREATE PROCEDURE [dbo].[spg_settlement_returned_guides] @IdManifest INT
AS
BEGIN
    ...
    DECLARE @Currency INT =
            (
                SELECT IdCatCurrencyCOD FROM CatCurrencyCOD WHERE Symbol = 'Q'
            );
    ...
    (
        ...
        WHERE ID_DeliveryOrderBySettlement = @IdManifest
    )
