        ...
        SELECT STUFF(
                        (
                            select distinct
                                ...
                                + dbo.fnt_String_Escape_MK12052022(
                                                           convert(
                                                                      NVARCHAR(50),
                                ...
                                + dbo.fnt_String_Escape_MK12052022(isnull(convert(varchar, vcp.NirPhone), 'json'), '') + '",'
                                + '"Phone":"'
                                + dbo.fnt_String_Escape_MK12052022(
                                                           isnull(
                                                                     convert(
                                ...
                                + dbo.fnt_String_Escape_MK12052022(isnull(convert(varchar, vcp.CUI), 'json'), '') + '",'
                                ...
                                + dbo.fnt_String_Escape_MK12052022(REPLACE(ISNULL(vcp.ContactName, ' '), '"', ''), 'json') + '",'
                                + '"Billing":['
                                + ISNULL(
                                            STUFF(
                                                     (
                                                         SELECT ',{ "IdBilling":"'
                                                                ...
                                                                + '"Status":"'
                                                                + isnull(convert(varchar, SUB.BlpRowStatus), ' ')
                                                                + '",' + '"Token":"'
                                            ...
                                            STUFF(
                                                     (
                                                         SELECT ',{ "Id":"'
                                                                ...
                                                                + '"NameBank":"'
                                                                + isnull(convert(varchar, DB.Name), '') + '",'
                                                                + '"NameAccount":"'
                                                                + dbo.fnt_String_Escape_MK12052022(
                                                                                           isnull(
                                                                                                     convert(
                                            ...
                                            STUFF(
                                                     (
                                                         SELECT DISTINCT
                                                             ...
                                                             + '"IdProvince":"'
                                                             + isnull(convert(varchar, pr.IdProvince), ' ') + '",'
                                                             + '"Province":"'
                                                             + isnull(convert(varchar, pr.ProvinceName), ' ') + '",'
                                                             + '"Township":"'
                                                             + isnull(convert(varchar, tw.TownshipName), ' ') + '",'
                                                             + '"HeaderCode":"'
                                                             + isnull(convert(varchar, tw.HeaderCode), ' ') + '",'
                                                             + '"IdAccount":"'
                                                             + isnull(convert(varchar, SUB.UadIdAccount), ' ') + '",'
                                                             + '"IdCountry":"'
