    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            FROM #TableAmountCODTemp                            tact
				...
				LEFT JOIN dbo.VisitPointClient VPC WITH(NOLOCK) ON VPC.CodeOfReference = do.Sender_ID
            ...
            FROM #TableAmountCODTemp         tact
				...
				LEFT JOIN dbo.VisitPointClient VPC WITH(NOLOCK) ON VPC.CodeOfReference = ORD.Sender_ID
                LEFT JOIN dbo.Customer      CS WITH (NOLOCK)
