...
-- =============================================
CREATE PROCEDURE [dbo].[GetDepositReportCOD_TEST]
...
BEGIN
    ...
    BEGIN
        ...
        SELECT s1.*,
               ...
               ISNULL(DATEDIFF(DAY, CONVERT(DATE, s1.FechaEntrega, 103), CONVERT(DATE, FORMAT(s1.FechaPago, 'dd/MM/yyyy hh:mm:ss tt'), 103)), 0) AS DiasPago
        FROM
        (
