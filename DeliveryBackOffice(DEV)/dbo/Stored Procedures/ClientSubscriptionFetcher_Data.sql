...
-- =============================================
CREATE PROCEDURE [dbo].[ClientSubscriptionFetcher_Data]
	@IdAccount INT = 0
AS
BEGIN
    BEGIN TRY
		 ...
		 --%Descuento
		 SELECT TOP 1 1 StatusResponse,Tbl1.IdCatProductCategory AS CatTypeSubscriptionId,tbl1.IdSubscription,SubscriptionName
		 ...
		 UNION
		 SELECT TOP 1 1 StatusResponse,Tbl1.IdCatProductCategory AS CatTypeSubscriptionId,tbl1.IdMembership AS IdSubscription,tbl1.MembershipName AS SubscriptionName
		 ,Tbl1.SubscriptionDescription
		 ,0 IncludeCollect
		 FROM 
		 (
    ...
    BEGIN CATCH
        ...
        SELECT 0,
			 0 CatTypeSubscriptionId,
			 ''SubscriptionName,
			 ERROR_MESSAGE() SubscriptionDescription,
			 0 IncludeCollect             
    END CATCH;
END;