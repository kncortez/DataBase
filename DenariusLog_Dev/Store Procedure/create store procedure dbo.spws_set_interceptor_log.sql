...
GO
-- =============================================
-- Author:		<Ramirez,Edwin>
-- Create date: <2020-08-19 0920>
-- Description:	<sp utilizado para almacenar en bitacora la informacion del consumo de nuestros servicios web>
-- =============================================
CREATE PROCEDURE spws_set_interceptor_log 
