...
-- Update date: <2021-12-31>
-- Description:	<Setup Usuario Portal Web Concesionario>
-- =============================================


CREATE PROCEDURE [dbo].[spws_SetHwConcesionaryUser]
...
DECLARE @IdVisitPointClient BIGINT;



SELECT @IdVisitPointClient = vc.CodeOfReference ,@denariusPassword = du.USR_Password, @firstName = dwd.USR_FirstName, @lastName = dwd.USR_LastName, @idCustomer= vc.CustomerID, @nationality = dwd.USR_ClientCardCodeCountry FROM DeliveryBackOffice.dbo.VisitPointClient vc WITH (NOLOCK)
...
INSERT INTO DeliveryBackOffice.dbo.RolByUserBySystem
						...
						,RusDateCreated
						,StationId)
						VALUES(@IdRol,1,@IdUser,1,'SYS-ADMIN', GETDATE(),1)
...
INSERT INTO DeliveryBackOffice.dbo.Account
						...
						VALUES(CAST(concat('Concesionario ',@firstName) AS VARCHAR(100)),4,1,'SYS-ADMIN',GETDATE(),@idCustomer,'C')
