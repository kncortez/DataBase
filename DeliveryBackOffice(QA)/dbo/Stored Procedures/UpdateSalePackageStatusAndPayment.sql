...
BEGIN
	...
	DECLARE @ActiveStatus INT = (SELECT TOP 1 CSPS.IdCatSalesPackageStatus FROM [DeliveryBackOffice].[dbo].[CatSalesPackageStatus] CSPS WITH(NOLOCK) WHERE CSPS.SalesPackageStatusName = 'Activa' COLLATE Latin1_General_CI_AI AND CSPS.RowStatus = 1);
	...
	BEGIN TRY
		...
		BEGIN
			...
			BEGIN
				...
				INSERT INTO
					[DeliveryBackOffice].[dbo].[MembershipPaymentLog]
				...
				BEGIN
					...
					BEGIN TRY
						INSERT INTO
							[DeliveryBackOffice].[dbo].[MembershipSubscriptionLog]
								(SystemId, ModuleId, MembershipId, SalesPackageStatusId, LogActionDescription, RowStatus, TokenCreated, DateCreated, LogTransactionId, LogTransactionOrder)
						SELECT
							TOP 1
								@SystemId, @ModuleId, Mmshp.IdMembership, Mmshp.CatMembershipStatusId, 'Exitosamente se actualizo el pago de la renovación de la membresia.', 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
						FROM
							[DeliveryBackOffice].[dbo].[Membership] Mmshp
						WHERE
							Mmshp.IdMembership = @SalePackageToRenew
					...
					BEGIN
						...
						BEGIN TRY
							...
							INSERT INTO
								[DeliveryBackOffice].[dbo].[MembershipSubscriptionLog]
									(SystemId, ModuleId, MembershipId, SalesPackageStatusId, LogActionDescription, RowStatus, TokenCreated, DateCreated)
							SELECT
								TOP 1
									@SystemId, @ModuleId, Mmshp.IdMembership, Mmshp.CatMembershipStatusId, 'Exitosamente se actualizo los datos de la membresia.', 1, @Token, GETDATE()
							FROM
								[DeliveryBackOffice].[dbo].[Membership] Mmshp
							WHERE
								Mmshp.IdMembership = @SalePackageToRenew
					...
					BEGIN
						...
						BEGIN TRY
							...
							SELECT
								TOP 1
									@SystemId, @ModuleId, Mmshp.IdMembership, Mmshp.CatMembershipStatusId, CONCAT('Error al actualizar la membresia con la autorización: ', @AuthorizationValue), 1, @Token, GETDATE()
							FROM
								[DeliveryBackOffice].[dbo].[Membership] Mmshp
							WHERE
								Mmshp.IdMembership = @SalePackageToRenew
				...
				BEGIN
					...
					BEGIN TRY
						...
						SELECT
							TOP 1
								@SystemId, @ModuleId, Mmshp.IdMembership, Mmshp.CatMembershipStatusId, CONCAT('Error al actualizar el pago de la membresia: ', @AuthorizationValue), 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
						FROM
							[DeliveryBackOffice].[dbo].[Membership] Mmshp
						WHERE
							Mmshp.IdMembership = @SalePackageToRenew
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN TRY
						...
						SELECT
							TOP 1
								@SystemId, @ModuleId, Mmshp.IdMembership, Mmshp.CatMembershipStatusId, 'Se rechaza la transacción del pago.', 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
						FROM
							[DeliveryBackOffice].[dbo].[Membership] Mmshp
						WHERE
							Mmshp.IdMembership = @SalePackageToRenew
				...
				BEGIN
					...
					BEGIN TRY
						...
						INSERT INTO
							[DeliveryBackOffice].[dbo].[MembershipSubscriptionLog]
								(SystemId, ModuleId, SalesPackageStatusId, LogActionDescription, RowStatus, TokenCreated, DateCreated, LogTransactionId, LogTransactionOrder)
						SELECT
							TOP 1
								@SystemId, @ModuleId, Mmshp.CatMembershipStatusId, 'Error al ingresar el rechazo del pago.', 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
						FROM
							[DeliveryBackOffice].[dbo].[Membership] Mmshp
						WHERE
							Mmshp.IdMembership = @SalePackageToRenew
		...
		BEGIN
			...
			BEGIN
				...
				INSERT INTO
					[DeliveryBackOffice].[dbo].[SubscriptionPaymentLog]
				...
				BEGIN
					...
					BEGIN TRY
						INSERT INTO
							[DeliveryBackOffice].[dbo].[MembershipSubscriptionLog]
								(SystemId, ModuleId, MembershipId, SubscriptionId, SalesPackageStatusId, LogActionDescription, RowStatus, TokenCreated, DateCreated, LogTransactionId, LogTransactionOrder)
						SELECT
							TOP 1
								@SystemId, @ModuleId, Sbscrptn.MembershipId, Sbscrptn.SubscriptionCode, Sbscrptn.CatSubscriptionStatusId, 'Exitosamente se actualizo el pago de la renovación de la subscripción.', 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
						FROM
							[DeliveryBackOffice].[dbo].[Subscription] Sbscrptn
						WHERE
							Sbscrptn.IdSubscription = @SalePackageToRenew
					...
					BEGIN
						...
						BEGIN TRY
							...
							INSERT INTO
								[DeliveryBackOffice].[dbo].[MembershipSubscriptionLog]
									(SystemId, ModuleId, MembershipId, SubscriptionId, SalesPackageStatusId, LogActionDescription, RowStatus, TokenCreated, DateCreated)
							SELECT
								TOP 1
									@SystemId, @ModuleId, Sbscrptn.MembershipId, Sbscrptn.IdSubscription, Sbscrptn.CatSubscriptionStatusId, 'Exitosamente se actualizo los datos de la membresia.', 1, @Token, GETDATE()
							FROM
								[DeliveryBackOffice].[dbo].[Subscription] Sbscrptn
							WHERE
								Sbscrptn.IdSubscription = @SalePackageToRenew
					...
					BEGIN
						...
						BEGIN TRY
							...
							SELECT
								TOP 1
									@SystemId, @ModuleId, Sbscrptn.MembershipId, Sbscrptn.IdSubscription, Sbscrptn.CatSubscriptionStatusId, CONCAT('Error al actualizar la membresia con la autorización: ', @AuthorizationValue), 1, @Token, GETDATE()
							FROM
								[DeliveryBackOffice].[dbo].[Subscription] Sbscrptn
							WHERE
								Sbscrptn.IdSubscription = @SalePackageToRenew
				...
				BEGIN
					...
					BEGIN TRY
						...
						SELECT
							TOP 1
								@SystemId, @ModuleId, Sbscrptn.MembershipId, Sbscrptn.IdSubscription, Sbscrptn.CatSubscriptionStatusId, CONCAT('Error al actualizar el pago de la membresia: ', @AuthorizationValue), 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
						FROM
							[DeliveryBackOffice].[dbo].[Subscription] Sbscrptn
						WHERE
							Sbscrptn.IdSubscription = @SalePackageToRenew
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN TRY
						...
						SELECT
							TOP 1
								@SystemId, @ModuleId, Sbscrptn.MembershipId, Sbscrptn.IdSubscription, Sbscrptn.CatSubscriptionStatusId, 'Se rechaza la transacción del pago.', 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
						FROM
							[DeliveryBackOffice].[dbo].[Subscription] Sbscrptn
						WHERE
							Sbscrptn.IdSubscription = @SalePackageToRenew
				...
				BEGIN
					...
					BEGIN TRY
						...
						SELECT
							TOP 1
								@SystemId, @ModuleId, Sbscrptn.MembershipId, Sbscrptn.IdSubscription, Sbscrptn.CatSubscriptionStatusId, 'Error al ingresar el rechazo del pago.', 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
						FROM
							[DeliveryBackOffice].[dbo].[Subscription] Sbscrptn
						WHERE
							Sbscrptn.IdSubscription = @SalePackageToRenew
	...
	BEGIN CATCH
		...
		BEGIN
			...
			SELECT
				TOP 1
					@SystemId, @ModuleId, Mmshp.IdMembership, Mmshp.CatMembershipStatusId, ERROR_MESSAGE(), 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
			FROM
				[DeliveryBackOffice].[dbo].[Membership] Mmshp
			WHERE
				Mmshp.IdMembership = @SalePackageToRenew
		...
		BEGIN
			...
			SELECT
				TOP 1
					@SystemId, @ModuleId, Sbscrptn.MembershipId, Sbscrptn.IdSubscription, Sbscrptn.CatSubscriptionStatusId, ERROR_MESSAGE(), 1, @Token, GETDATE(), @TransactionId, @TransactionOrder
			FROM
				[DeliveryBackOffice].[dbo].[Subscription] Sbscrptn
			WHERE
				Sbscrptn.IdSubscription = @SalePackageToRenew
