...
BEGIN
    ...
    BEGIN
        ...
        BEGIN TRY
            ...
            VALUES
            (@VpCodeOfReferences, @cmp_nit, @cli_name, @cli_adress, @cli_nit, @cli_email, GETDATE(), @IVA, @amount, 1,
             GETDATE(), @tokenRegister, @type, @systemOrigen);
            ...
            SELECT @invoiceHeaderId,
                   CASE
                       WHEN LstDtl.orderNumber <= 0 THEN
                           NULL
                       ELSE
                           LstDtl.orderSerie
                   END,
