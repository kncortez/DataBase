...
BEGIN
    ...
    SELECT CONCAT(do.Guide_Serie, do.Guide_Number) NUMGUIA,
           ...
           CASE
               WHEN X.Pieces = (ISNULL(do.Pieces_Dry, 0) + ISNULL(do.Pieces_Cold, 0)) THEN
                   1
               ELSE
                   0
