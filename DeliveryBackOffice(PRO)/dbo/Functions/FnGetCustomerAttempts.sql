...
-- Description:	<Función para determinar los intentos de entrega que se mostraran en la guía dependiendo del cliente y del tarifario que posea dicho cliente>
-- =============================================
