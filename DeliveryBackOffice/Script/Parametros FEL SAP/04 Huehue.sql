...
Declare @VpCodeOfReference as int = 4247,
@FELestablecimiento as int = 4,
@FELcorreoExpressCenter as varchar(500) = 'express.huehuetenango@forzadelivery.com',
@SAPserieFactura as varchar(10) = '60',
@SAPserieNC as varchar(10) = '64',
@SAPseriePago as varchar(10) = '68',
@SAPCardCode as varchar(150) = 'CEC0004',
@SAPCreditCard as varchar(15) = '3'
