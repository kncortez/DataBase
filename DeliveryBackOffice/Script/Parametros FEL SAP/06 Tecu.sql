...
Declare @VpCodeOfReference as int = 4261,
@FELestablecimiento as int = 6,
@FELcorreoExpressCenter as varchar(500) = 'express.teculutan@forzadelivery.com',
@SAPserieFactura as varchar(10) = '62',
@SAPserieNC as varchar(10) = '66',
@SAPseriePago as varchar(10) = '70',
@SAPCardCode as varchar(150) = 'CEC0006',
@SAPCreditCard as varchar(15) = '5'
