...
Declare @VpCodeOfReference as int = 4246,
@FELestablecimiento as int = 3,
@FELcorreoExpressCenter as varchar(500) = 'express.coban@forzadelivery.com',
@SAPserieFactura as varchar(10) = '59',
@SAPserieNC as varchar(10) = '63',
@SAPseriePago as varchar(10) = '67',
@SAPCardCode as varchar(150) = 'CEC0003',
@SAPCreditCard as varchar(15) = '2'
