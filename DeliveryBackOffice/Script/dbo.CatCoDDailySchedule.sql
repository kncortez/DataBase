...
VALUES
	...
	-- Procesos de lotes diarios de CoD
		-- Lote 07:05:00
		('COD_Daily_Batch', 1, '07:05:00', 1, 'SYS-ARUIZ', GETDATE()),
		('COD_Daily_Batch', 3, '07:05:00', 1, 'SYS-ARUIZ', GETDATE()),
		('COD_Daily_Batch', 5, '07:05:00', 1, 'SYS-ARUIZ', GETDATE()),
		('COD_Daily_Batch', 31, '07:05:00', 1, 'SYS-ARUIZ', GETDATE()),
		('COD_Daily_Batch', 33, '07:05:00', 1, 'SYS-ARUIZ', GETDATE()),

		-- Lote 20:05:00
		('COD_Daily_Batch', 1, '20:05:00', 1, 'SYS-ARUIZ', GETDATE()),
		('COD_Daily_Batch', 3, '20:05:00', 1, 'SYS-ARUIZ', GETDATE()),
		('COD_Daily_Batch', 5, '20:05:00', 1, 'SYS-ARUIZ', GETDATE()),
		('COD_Daily_Batch', 31, '20:05:00', 1, 'SYS-ARUIZ', GETDATE()),
		('COD_Daily_Batch', 33, '20:05:00', 1, 'SYS-ARUIZ', GETDATE()),
	-- Procesos de lotes de comisiones y envios
		-- Lote 14:10:00
		('Commision_Batch', 31, '14:10:00', 1, 'SYS-ARUIZ', GETDATE()),
		-- Lote 22:10:00
		('Commision_Batch', 31, '22:10:00', 1, 'SYS-ARUIZ', GETDATE()),
	...
	-- Procesos de envio de reportes a clientes por depositos
		-- Lote 20:30:00
		('Customer_Daily_Report', 31, '20:30:00', 1, 'SYS-ARUIZ', GETDATE())