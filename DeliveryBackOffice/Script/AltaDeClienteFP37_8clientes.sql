...
-- IMPORTADORA D KALIDAD
INSERT INTO [DeliveryBackOffice].[dbo].[Customer] ([Name], [Description], [Domain], [RegexSubject], [RegexEmail], [RegexFilename], [Abbreviation]) 
VALUES ('IMPORTADORA D KALIDAD', 'IMPORTADORA D KALIDAD', '@hotmail.com','^.*solicitud.*$','^josemido1705@hotmail.com$','^envios_.*\.xls$','IMPORTADORA')
  
INSERT INTO [DeliveryBackOffice].[dbo].[VisitPointClient] ([CodeOfReference],[DescriptionOfClient],[StatusClient],[CountryId],[VisitPointId],[TokenCreated],
[DateCreated],[TokenUpdated],[DateUpdated],[CustomerID],[Address],[Zone],[Town],[Department],[Phone],[ContactName])
VALUES (13742,'IMPORTADORA D KALIDAD',1,'GT',138299,'ERIVAS',GETDATE(),NULL,NULL,102,'Zona 4, Lot. Peralta, Retalhuleu'
,4,'RETALHULEU','RETALHULEU','50021118','IMPORTADORA D KALIDAD')


-- AGUEDA AILEN GRIMALDI GARUTI
INSERT INTO [DeliveryBackOffice].[dbo].[Customer] ([Name], [Description], [Domain], [RegexSubject], [RegexEmail], [RegexFilename], [Abbreviation]) 
VALUES ('AGUEDA AILEN GRIMALDI GARUTI', 'AGUEDA AILEN GRIMALDI GARUTI', '@gmail.com','^.*solicitud.*$','^grimaldi.garuti@gmail.com$','^envios_.*\.xls$','AGUEDA GRIMALDI')
  
INSERT INTO [DeliveryBackOffice].[dbo].[VisitPointClient] ([CodeOfReference],[DescriptionOfClient],[StatusClient],[CountryId],[VisitPointId],[TokenCreated],
[DateCreated],[TokenUpdated],[DateUpdated],[CustomerID],[Address],[Zone],[Town],[Department],[Phone],[ContactName])
VALUES (13747,'AGUEDA AILEN GRIMALDI GARUTI',1,'GT',138287,'ERIVAS',GETDATE(),NULL,NULL,103,'Carretera Salvador'
,0,'GUATEMALA','GUATEMALA','53683742','AGUEDA GRIMALDI')


-- GUATEBODEGAS
INSERT INTO [DeliveryBackOffice].[dbo].[Customer] ([Name], [Description], [Domain], [RegexSubject], [RegexEmail], [RegexFilename], [Abbreviation]) 
VALUES ('GUATEBODEGAS', 'GUATEBODEGAS', '@gmail.com','^.*solicitud.*$','^guatebodegas@gmail.com$','^envios_.*\.xls$','GUATEBODEGAS')
  
INSERT INTO [DeliveryBackOffice].[dbo].[VisitPointClient] ([CodeOfReference],[DescriptionOfClient],[StatusClient],[CountryId],[VisitPointId],[TokenCreated],
[DateCreated],[TokenUpdated],[DateUpdated],[CustomerID],[Address],[Zone],[Town],[Department],[Phone],[ContactName])
VALUES (13752,'GUATEBODEGAS',1,'GT',138294,'ERIVAS',GETDATE(),NULL,NULL,104,''
,8,'VILLA NUEVA','GUATEMALA','54226770','GUATEBODEGAS')
