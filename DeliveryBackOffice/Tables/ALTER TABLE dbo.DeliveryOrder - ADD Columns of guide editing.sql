...
SET @v3 = N'altered guide, yes or not'
EXECUTE sp_addextendedproperty N'MS_Description', @v3, N'SCHEMA', N'dbo', N'TABLE', N'DeliveryOrder', N'COLUMN', N'AlteredInformation'
