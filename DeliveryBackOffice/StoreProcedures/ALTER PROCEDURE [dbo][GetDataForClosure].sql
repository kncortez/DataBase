...
ALTER PROCEDURE [dbo].[GetDataForClosure]
...
INSERT INTO @TEMPLATEDETAIL  (
   ...
   SELECT IND.dti_fk_orderSerie,
    ...
    FROM dbo.DeliveryOrder DOR
        ...
        JOIN DeliveryBackOffice.dbo.DeliveryOrderPaymentTransaction DOPD
   ...
   -- ORDER BY DOPD.DateCreated DESC;
	---------------------------------------------------------------------------------------------
	UNION ALL
	 SELECT DOPD.DateCreated 'DateCreatedTransaction', DOPD.DateCreated 'DateCreated',
    ...
    FROM DeliveryBackOffice.dbo.DeliveryOrderPaymentTransaction dpd
