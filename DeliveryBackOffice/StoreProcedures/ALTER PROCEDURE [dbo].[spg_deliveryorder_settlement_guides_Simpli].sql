...
GO
/****** Object:  StoredProcedure [dbo].[spg_deliveryorder_settlement_guides_Simpli]    Script Date: 20/12/2021 14:59:50 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[spg_deliveryorder_settlement_guides_Simpli]
		@IdManifest INT
AS
BEGIN
