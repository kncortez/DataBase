...
GO
/****** Object:  StoredProcedure [dbo].[spws_set_route_settlement_status]    Script Date: 27/01/2022 13:00:10 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRY
		...
		, DateCreated)
			...
			OR (dopd.DopId IS NOT NULL
			AND ra.IdRouteAssigment IS NOT NULL)
			OR dopd.IdHeaderRecolection IS NULL)
