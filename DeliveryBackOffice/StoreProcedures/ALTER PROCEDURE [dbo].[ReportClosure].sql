...
GO
/****** Object:  StoredProcedure [dbo].[ReportClosure]    Script Date: 6/04/2022 11:38:15 ******/
SET ANSI_NULLS ON
GO
...
begin
	...
	WHERE  CONVERT(DATE, DOPD.DateCreated) BETWEEN  CONVERT(DATE, @StartDate) 
		...
		AND (DOR.Sender_ID = @VisitPointId OR DOPD.AccountId = @IdAccount OR DOPD.VisitPoint = @VisitPointId)
