...
GO
/****** Object:  StoredProcedure [dbo].[sps_settlement_guide_returned]    Script Date: 28/04/2021 15:29:08 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sps_settlement_guide_returned_LinehaulsReturns]
	...
	BEGIN TRANSACTION
		...
		BEGIN TRY
			...
			SET 
				TokenUpdated = @Token, 
				DateUpdated = GETDATE(), 
				IsReturn = 1 -- guía liquidada en bodega
			...
			INSERT INTO [dbo].[DeliveryOrderDetail]
			 ...
			 VALUES
				...
				SET StatusOrderId = 8 --Status of delivery 			
