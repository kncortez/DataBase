...
/****** Object:  StoredProcedure [dbo].[spg_guides_by_courierphone]    Script Date: 17/01/2021 13:39:39 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	(  
		...
		WHERE sr.Phone like '%' + @PhoneNumber + '%'
			...
			GROUP BY da.Guide_Serie, da.Guide_Number, da.ID_Courier, da.StatusPay
	) AS subq
