...
GO
/****** Object:  StoredProcedure [dbo].[spg_settlement_cod_guides]    Script Date: 14/12/2021 14:24:47 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	LEFT JOIN [dbo].VisitPointClient vps ON vps.CodeOfReference = do.Sender_ID
    LEFT JOIN [dbo].[Customer] cu ON ISNULL(do.[IdCustomer], vps.CustomerID) = cu.[IdCustomer]
