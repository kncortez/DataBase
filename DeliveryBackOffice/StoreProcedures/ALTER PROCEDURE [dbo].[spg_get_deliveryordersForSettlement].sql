...
GO
/****** Object:  StoredProcedure [dbo].[spg_get_deliveryordersForSettlement]    Script Date: 20/12/2021 15:08:59 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	JOIN DeliveryBackOffice.dbo.DeliverySettlementDetail dsd ON dsd.ID_DeliveryOrderBySettlement = dbs.ID AND dsd.RowStatus = 1
