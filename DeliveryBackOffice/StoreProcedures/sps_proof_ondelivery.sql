...
/****** Object:  StoredProcedure [dbo].[sps_set_sender_receiver]    Script Date: 8/08/2020 19:44:39 ******/
SET ANSI_NULLS ON
GO
	...
	BEGIN TRANSACTION
		...
		BEGIN TRY
			...
			BEGIN
				...
				UPDATE DeliveryBackOffice.dbo.DeliveryAttempt SET Delivered = 1, ID_Proof = @ID_Photo WHERE ID IN (SELECT ID FROM @Table)
