...
GO
/****** Object:  StoredProcedure [dbo].[spg_deliveryorder_settlement_guides]    Script Date: 28/09/2021 10:50:45 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	,CONVERT(INT,ISNULL(REPLACE(RTRIM(do.Receiver_Zone),CHAR(160),''),0)) AS Receiver_Zone
