...
GO
/****** Object:  StoredProcedure [dbo].[spg_deliveryorder_settlement_guides]    Script Date: 20/12/2021 14:55:12 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	where do.Guide_Serie = (SELECT DISTINCT TOP 1 Guide_Serie FROM [DeliveryBackOffice].[dbo].[DeliverySettlementDetail] WHERE ID_DeliveryOrderBySettlement = @IdManifest AND RowStatus = 1)
