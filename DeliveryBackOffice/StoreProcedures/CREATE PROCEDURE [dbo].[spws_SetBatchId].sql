...
GO
/****** Object:  StoredProcedure [dbo].[spws_SetBatchId]    Script Date: 9/7/2021 10:54:38 AM ******/
SET ANSI_NULLS ON
GO
...
-- Main IF
IF EXISTS (SELECT TOP 1 * FROM DeliveryBackOffice.dbo.GuideBatch WITH (NOLOCK) WHERE  IdUser=@IdUser)
        ...
        IF(@Status=1)
          ...
          BEGIN
              ...
              BEGIN TRY
                  ...
                  TokenCreated,
                  DateCreated)
                  VALUES(@IdUser,@GuideNumber,@IdBatch,@IdVisitPointByClientPortfolio,@IdAddress,@Status,1,'SYS-ADMIN',GETDATE());
        ...
        ELSE
          ...
          BEGIN
            ...
            BEGIN TRY
                ...
                TokenCreated,
                DateCreated)
                VALUES(@IdUser,@GuideNumber,@IdBatch,@IdVisitPointByClientPortfolio,@IdAddress,1,1,'SYS-ADMIN',GETDATE());
...
-- This is a new customer that will add the first guide to the table GuideBatch so an IdBatch needs to be created, this will starts at 1 by default
      ...
      BEGIN
        ...
        BEGIN TRY
            ...
            TokenCreated,
            DateCreated)
            VALUES(@IdUser,@GuideNumber,1,@IdVisitPointByClientPortfolio,@IdAddress,1,1,'SYS-ADMIN',GETDATE());
