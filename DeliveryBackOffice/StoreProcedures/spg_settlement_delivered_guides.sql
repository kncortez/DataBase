...
/****** Object:  StoredProcedure [dbo].[spg_settlement_delivered_guides]    Script Date: 24/11/2020 19:56:15 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	JOIN DeliveryBackOffice.dbo.DeliverySettlementDetail dsd ON dsd.Guide_Serie = do.Guide_Serie AND dsd.Guide_Number = do.Guide_Number
