...
GO
/****** Object:  StoredProcedure [dbo].[SetFinishPickUp]    Script Date: 5/05/2022 10:35:35 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	*/
                ...
                SELECT DISTINCT lge.ItemSerie GuideSerie,
                ...
                FROM #listGuides lge
                    INNER JOIN dbo.DeliveryOrder dlo
                    ...
                    LEFT JOIN ProcessedGuideCOD pcd
            ...
            INNER JOIN DeliveryBackOffice.dbo.Customer cu ON cu.IdCustomer = vpc.CustomerID
