...
GO
/****** Object:  StoredProcedure [dbo].[spw_get_geliveryorders_track]    Script Date: 25/10/2021 09:25:10 ******/
SET ANSI_NULLS ON
GO
			...
			BEGIN
				...
				SELECT CAST(serv.Sender_ID AS VARCHAR) + ' - ' + 
					   ...
					   CASE WHEN (SELECT TOP (1) acc.IdCustomer 
							...
							WHEN
							(select count(1) from DeliveryBackOffice.dbo.Account ACC  
						...
						CASE serv.IsCollect when 'true' then CAST(serv.PriceShippment AS VARCHAR(50)) ELSE '0.00' end [AmountShipment] ,
