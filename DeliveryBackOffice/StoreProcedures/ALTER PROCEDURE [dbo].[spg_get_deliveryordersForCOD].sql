...
-- =============================================
ALTER PROCEDURE [dbo].[spg_get_deliveryordersForCOD] @IdManifest INT
AS
BEGIN
	SET NOCOUNT ON;
	...
	INSERT @StatusOrderValid EXEC GetStatusOrderValid @GuideSerie
													 ,@GuideNumber
													 ,@StatusOrderId = 24


	UPDATE @GuidesDetail
	SET StatusOrderValid = (SELECT TOP 1
				StatusCode
			FROM @StatusOrderValid)
