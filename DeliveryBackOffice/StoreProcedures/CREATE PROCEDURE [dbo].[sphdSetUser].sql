...
BEGIN
	...
	BEGIN TRANSACTION MNGMNTUSR
		...
		SELECT  CAST(@IdPerson AS NVARCHAR(10))			[IdPerson],
				CAST(@IdRegisterUser AS NVARCHAR(10))	[IdRegisterUser], 
				CAST(@Par@IdEmployee AS NVARCHAR(10))	[IdEmployee],
				CAST(@IdAccount	 AS NVARCHAR(10))		[IdAccount],
				CAST(1 AS NVARCHAR(10))					[IdResult],
									'' 					[ErrorNumber],
									''					[ErrorSeverity],
									''					[ErrorState],
									''					[ErrorProcedure],
									''					[ErrorLine],
				'Successfull'							[ErrorMessage]
	...
	BEGIN CATCH 
	  IF (@@TRANCOUNT > 0)
	   ...
	   END 
		SELECT
			CAST(@IdPerson AS NVARCHAR(10))			[IdPerson],
			CAST(@IdRegisterUser AS NVARCHAR(10))	[IdRegisterUser], 
			CAST(@Par@IdEmployee AS NVARCHAR(10))	[IdEmployee],
			CAST(@IdAccount	 AS NVARCHAR(10))		[IdAccount],
			CAST(0 AS NVARCHAR(10))					[IdResult],
			...
			CAST(ERROR_MESSAGE() AS NVARCHAR(MAX))	[ErrorMessage]
	END CATCH
