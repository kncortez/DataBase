...
/****** Object:  StoredProcedure [dbo].[SetCollectGuides]    Script Date: 07/02/2021 15:59:45 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRANSACTION
		BEGIN TRY
			...
			update DeliveryOrder set PriceShippment = isnull(PriceShippment,0) + isnull(@Recot,3.00), IsCollect = 1
			from #listGuides ls
