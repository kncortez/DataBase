...
/****** Object:  StoredProcedure [dbo].[sp_generate_batch_cod]    Script Date: 20/07/2021 19:12:35 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN
		...
		SELECT *, @MaxBatchNumber as BATCHNUMBER FROM #TableDistinctBankFinalIndexTemp
