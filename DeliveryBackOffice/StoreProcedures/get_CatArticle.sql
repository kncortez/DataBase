...
/****** Object:  StoredProcedure [dbo].[get_CatArticle]    Script Date: 15/02/2022 10:33:38 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	<Retorna las categorías genericas de los articulos>
-- =============================================
ALTER PROCEDURE [dbo].[get_CatArticle]
	@guideNumber AS INT,
