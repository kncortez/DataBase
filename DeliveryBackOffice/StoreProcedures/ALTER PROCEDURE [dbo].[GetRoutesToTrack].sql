...
GO
/****** Object:  StoredProcedure [dbo].[GetRoutesToTrack]    Script Date: 20/12/2021 14:35:15 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[GetRoutesToTrack]
	@Date DATE,
...
BEGIN
	...
	,MAX(
		CASE 
			WHEN ISNULL(DO.Courier_Route,'N/A') LIKE 'U%' THEN ISNULL(DO.Courier_Route,'N/A')
			ELSE 'N/A'
		END
	) 'Route'
	,DOBS.ID 'Manifest'
